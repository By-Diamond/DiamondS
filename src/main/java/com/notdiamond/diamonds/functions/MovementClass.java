    ...
    public void onRenderGameOverlay(RenderGameOverlayEvent e) {
        if (e.type == RenderGameOverlayEvent.ElementType.TEXT){
            ...
            if(Functions.GetStatus("Sprint")&& Minecraft.getMinecraft().fontRendererObj != null){
                Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow("§6Sprint §aOn", 2, scaled.getScaledHeight()-10, 0xFFFFFF);
            }
            if(Functions.GetStatus("Sneak") && Minecraft.getMinecraft().fontRendererObj != null){
                if(Functions.GetStatus("Sprint")){
                    Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow("§6Sneak §aOn", 2, scaled.getScaledHeight() - 20, 0xFFFFFF);
                }else{
                    Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow("§6Sneak §aOn", 2, scaled.getScaledHeight() - 10, 0xFFFFFF);
                }
            }
        }
